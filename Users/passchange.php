...
$sql=mysqli_query($con,"SELECT Pwd FROM users where Pwd='$oldpass' && Username='$username'");
$num=mysqli_fetch_array($sql);

if($num>0)
{
 $con=mysqli_query($con,"update users set Pwd=' $newpassword' where Username='$username'");
