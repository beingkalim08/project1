...
if(isset($_POST["submit"]))
{
 ...
 {
  $error .= '<p><label class="text-danger">Please Enter your Disease</label></p>';
 }
 else
 {
  $DISEASE = clean_text($_POST["DISEASE"]);
 }
 ...
 if($error == '')
 {
  $file_open = fopen("../Data/ModifiedPatientDetails.csv", "a");
  $no_rows = count(file("../Data/ModifiedPatientDetails.csv"));
  if($no_rows > 1)
  {
   $no_rows = ($no_rows - 1) + 1;
  }
...
<form method="post" id="nameform"> 
  ...
  <div class="imgcontainer">
    <img src="../images/patient1.png" height="90" width="90" alt="Avatar" class="avatar">
  </div>
  <p><?php echo $error; ?></p>
...
<br>
  ...
  <br><br>
  <!-- Disease -->
  <label for="DISEASE"><font color="purple">Enter Disease:</font></label>
  <select id="DISEASE" name="DISEASE">
    <option value="<?php echo $DISEASE; ?>"> </option>
    <option value="Seabies">Seabies</option>
    <option value="Anaemia">Anaemia</option>
    <option value="Dengue">Dengue</option>
    <option value="Neurities">Neurities</option>
    <option value="Measles">Measles</option>
    <option value="Dysentry">Dysentry</option>
    <option value="Pneumonia">Pneumonia</option>
    <option value="Typhoid">Typhoid</option>
    <option value="EntericFever">EntericFever</option>
    <option value="Bronchitis">Bronchitis</option>
    <option value="Acidity">Acidity</option>
    <option value="RespiratoryTrackInfection">RespiratoryTrackInfection</option>
    <option value="Gout">Gout</option>
    <option value="Gastroentrytis">Gastroentrytis</option>
    <option value="Asthma">Asthma</option>
    <option value="Anoroxia">Anoroxia</option>
    <option value="Tuberculosis">Tuberculosis</option>
    <option value="ChickenPox">ChickenPox</option>
    <option value="Diarrhoea">Diarrhoea</option>
    <option value="HighBloodPressure">HighBloodPressure</option>
    <option value="CommonCold">CommonCold</option>
  </select>
